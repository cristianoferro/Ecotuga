...
if(isset($_GET['id_apagar']) ){
  ...
  mysqli_query($ligacao, "DELETE FROM norte WHERE id = $id");
}
...
mysqli_query($ligacao, "INSERT INTO norte
...
//guardar numa variável uma consulta à base de dados
  $consulta = mysqli_query($ligacao, "SELECT * FROM norte ORDER BY id");
      ...
      <br/>
            ...
            <div class="item">
                ...
                <div class="lista-index">
                  ...
                  <div class="icones">
                  <a href=" norte_editar.php?id=<?php echo $norte[$i]['id']; ?>" class="botao_editar">
                      <img title="Editar" class="right" src="img/edit.png">
                      </img>
                    </a>
                    <a href="norte.php?id_apagar=<?php echo $norte[$i]['id']; ?>" title="Apagar" class="delete"><img class="delete-icon" src="img/delete.png"></img></a>
              </div>
                    <div class="lista-img">
