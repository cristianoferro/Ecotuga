...
if(isset($_GET['id_apagar']) ){
  ...
  mysqli_query($ligacao, "DELETE FROM sul WHERE id = $id");
}
...
mysqli_query($ligacao, "INSERT INTO sul
...
//guardar numa variável uma consulta à base de dados
  $consulta = mysqli_query($ligacao, "SELECT * FROM sul ORDER BY id");
      ...
      <br/>
            ...
            <div class="item">
                ...
                <div class="lista-index">
                  ...
                  <div class="icones">
                  <a href=" sul_editar.php?id=<?php echo $sul[$i]['id']; ?>" class="botao_editar">
                      <img title="Editar" class="right" src="img/edit.png">
                      </img>
                    </a>
                    <a href="sul.php?id_apagar=<?php echo $sul[$i]['id']; ?>" title="Apagar" class="delete"><img class="delete-icon" src="img/delete.png"></img></a>
              </div>
                    <div class="lista-img">
