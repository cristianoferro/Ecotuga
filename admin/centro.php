...
if(isset($_GET['id_apagar']) ){
  ...
  mysqli_query($ligacao, "DELETE FROM centro WHERE id = $id");
}
...
//guardar numa variável uma consulta à base de dados
  $consulta = mysqli_query($ligacao, "SELECT * FROM centro ORDER BY id");
      ...
      <br/>
            ...
            <div class="item">
                ...
                <div class="lista-index">
                  ...
                  <div class="icones">
                  <a href=" centro_editar.php?id=<?php echo $centro[$i]['id']; ?>" class="botao_editar">
                      <img title="Editar" class="right" src="img/edit.png">
                      </img>
                    </a>
                    <a href="centro.php?id_apagar=<?php echo $centro[$i]['id']; ?>" title="Apagar" class="delete"><img class="delete-icon" src="img/delete.png"></img></a>
              </div>
                    <div class="lista-img">
